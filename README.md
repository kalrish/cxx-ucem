...
###  Documentation
Building the documentation is optional. Doxygen is used for the task. Note that it has to run on the processed headers, i.e., after the build is finished. Simply run:
